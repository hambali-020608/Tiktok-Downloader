      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:flex md:justify-between md:items-center mb-10">
          <div className="mb-6 md:mb-0">
            <a href="https://tik-down-seven.vercel.app/" className="flex items-center">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 flex justify-center space-x-5 sm:mt-0">
            {/* Ganti href="#" dengan link sosial media Anda jika ada */}
            <a
              href="#"
